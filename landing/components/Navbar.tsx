    ...
    <nav className="sticky top-0 z-50 w-full bg-background-dark/80 backdrop-blur-md border-b border-primary/10">
      <div className="max-w-7xl mx-auto flex items-center p-4 justify-between">
        <Link to="/" className="flex items-center gap-2 cursor-pointer group">
          <div className="flex size-10 items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-all overflow-hidden">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-primary text-background-dark px-5 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all">
            Get Android
          </button>
        </div>
      </div>
